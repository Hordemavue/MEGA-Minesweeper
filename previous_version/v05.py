...
paused = False  # Variable pour vérifier si le jeu est en pause
pause_start_time = None  # Moment où la pause commence
pause_duration = 0  # Durée totale de la pause en secondes
# ===================================
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if game_over or win or paused:  # Ne continue pas les actions si le jeu est en pause
            continue
